<%@ Page Title="" Language="C#" MasterPageFile="~/Project/admin/MasterPage2.master" AutoEventWireup="true" CodeFile="index.aspx.cs" Inherits="admin_index" %>
            ...
            <div class="page-width-1 page-left">
              <div class="d-flex position-relative tm-border-top tm-border-bottom intro-container">
                <div class="intro-left tm-bg-dark">
                  <h2 class="mb-4">Welcome to Perfect studio's Admin Side</h2>
                 <%-- <p class="mb-4">
               ...
               --%> </div>
                <div class="intro-right">
                  <img src="img/home.jpeg" alt="Image" class="img-fluid intro-img-1">
                </div>
