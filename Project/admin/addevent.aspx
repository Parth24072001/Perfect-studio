<%@ Page Title="" Language="C#" MasterPageFile="~/Project/admin/MasterPage2.master" AutoEventWireup="true" CodeFile="addevent.aspx.cs" Inherits="admin_index" %>
            ...
            <div class="row">
                <%--<form method="POST" class="contact-form">--%>
                    <div class="col-md-6 tm-contact-left">
                        <div class="input-group tm-mb-30">
                            <asp:DropDownList ID="DropDownList1" runat="server" class="form-control rounded-0 border-top-0 border-end-0 border-start-0">
                                ...
                                <asp:ListItem Value="Baby_Shower" style="background-color:black">Baby Shower</asp:ListItem>
                            </asp:DropDownList>
                        </div>
                        <div class="input-group tm-mb-30">
                    ...
                    <div class="input-group justify-content-end">
                        <asp:Button ID="add" runat="server" class="btn btn-primary tm-btn-pad-2" Text="Add" OnClick="add_Click" />
                    </div>
                <%--</form>--%>
            </div>
        </div>
