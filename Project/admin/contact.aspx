<%@ Page Title="" Language="C#" MasterPageFile="~/Project/admin/MasterPage2.master" AutoEventWireup="true" CodeFile="contact.aspx.cs" Inherits="admin_contact" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    ...
    <div class="container">
        ...
        <div class="content clearfix" style="margin-top: -10vh">
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="id" DataSourceID="SqlDataSource1" BackColor="White" BorderColor="#E7E7FF" BorderStyle="None" BorderWidth="1px" CellPadding="25" CellSpacing="20" GridLines="Horizontal" Font-Bold="true" Style="margin-left: -15vh;">
            ...
            <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:perfectstudio %>' SelectCommand="SELECT * FROM [contact]"></asp:SqlDataSource>
        </div>
    </div>
